...
# CATEGORIES = ["", "", "", "", "", ""]
CATEGORIES = ["cs.ir", "cs.it"] # cs.hc, cs.ai, cs.cl, cs.ne, cs.ro, cs.lg, cs.se, cs.os, cs.db, cs.ar cs.ce, cs.cc, cs.cg, cs.cr, cs.cy, cs.dc, cs.dl, cs.dm, cs.ds, cs.et, cs.fl, cs.gl, cs.gr, cs.gt,  cs.cv(99%), econ.math,
START_YEAR = 2007
END_YEAR = 2025
